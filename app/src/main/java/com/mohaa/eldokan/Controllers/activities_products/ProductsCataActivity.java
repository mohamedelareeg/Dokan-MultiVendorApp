...
public class ProductsCataActivity extends BaseActivity implements OnProductClickListener  , CartProductsAdapter.CartProductsAdapterListener , OnCallbackReceived {


    private static final String TAG = "ProductsCataActivity";
    private Menu menu;
...
// Set Toolbar
    ...
    public void getAllPosts()
    {
        ...
        products_list.clear();
            ...
            Query f_query = productsRef.whereEqualTo("type" , type).orderBy("name", Query.Direction.ASCENDING).limit(limit);
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()) {
                        for (DocumentSnapshot document : task.getResult()) {
                            ...
                            //Toasty.info(ProductsCataActivity.this,getResources().getString(R.string.item_count) + " " + products_list.size() ,Toast.LENGTH_SHORT,true).show();
                        }
                        ...
                        RecyclerView.OnScrollListener onScrollListener = new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                                ...
                                if (isScrolling && (firstVisibleItemPosition + visibleItemCount == totalItemCount) && !isLastItemReached) {
                                    ...
                                    Query  nextQuery = productsRef.whereEqualTo("type" , type).orderBy("name", Query.Direction.ASCENDING).startAfter(lastVisible).limit(limit);
    ...
    public void onProductClicked(Products contact, int position) {
        Intent loginIntent = new Intent(ProductsCataActivity.this, IndividualProductActivity.class);
