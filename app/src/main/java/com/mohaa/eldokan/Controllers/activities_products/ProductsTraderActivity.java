...
public class ProductsTraderActivity extends BaseActivity implements OnProductClickListener  , CartProductsAdapter.CartProductsAdapterListener , OnCallbackReceived {
    ...
    int cartCount = 0;
    private TextView count , trader_name , trader_cate;
...
// Set Toolbar
    ...
    private void init() {
        ...
        trader_cate = findViewById(R.id.trader_cate);
        type = getIntent().getStringExtra(ProductsUI.BUNDLE_PRODUCTS_TYPE);
        trader = getIntent().getStringExtra(ProductsUI.BUNDLE_PRODUCTS_TRADER);

        trader_name.setText(trader);
        trader_cate.setText(type);
    ...
    public void getAllPosts()
    {
        ...
        products_list.clear();
            ...
            Query f_query = productsRef.whereEqualTo("trader" , trader).orderBy("name", Query.Direction.ASCENDING).limit(limit);
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()) {
                        for (DocumentSnapshot document : task.getResult()) {
                            ...
                            //Toasty.info(ProductsTraderActivity.this,getResources().getString(R.string.item_count) + " " + products_list.size() ,Toast.LENGTH_SHORT,true).show();
                        }
                        ...
                        RecyclerView.OnScrollListener onScrollListener = new RecyclerView.OnScrollListener() {
                            ...
                            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                                ...
                                if (isScrolling && (firstVisibleItemPosition + visibleItemCount == totalItemCount) && !isLastItemReached) {
                                    ...
                                    Query  nextQuery = productsRef.whereEqualTo("trader" , trader).orderBy("name", Query.Direction.ASCENDING).startAfter(lastVisible).limit(limit);
