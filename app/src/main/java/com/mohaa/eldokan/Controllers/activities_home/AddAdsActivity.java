...
public class AddAdsActivity extends BaseActivity {
    ...
    public void uploadFile(File file , final String user_name  , final String desc ,final String discount , final String owner_name) {
        ...
        try {
            compressedImageFile = new Compressor(AddAdsActivity.this)//Compressor Library
                    .setMaxWidth(1280)
                    .setMaxHeight(720)
                    .setQuality(20)
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                storageReference.child(filePaths.FIREBASE_IMAGE_STORAGE + "/" + user_id + "/ads_pics/").child(randomname + ".jpg").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        traders.setType("product");
                        traders.setProducts_uri(traders_list.getType());
                        traders.setProducts_name(sellProducts.getName());
                        ...
                        fStore.collection("ads").add(traders).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                            ...
                            public void onSuccess(DocumentReference documentReference) {
                                if (task.isSuccessful()) {
                                   ...
                                   // Toast.makeText(AddAdsActivity.this, uri.toString(), Toast.LENGTH_SHORT).show();
                                    //Toast.makeText(SetupActivity.this, "The User Settings Are Updated", Toast.LENGTH_SHORT).show();
                                    Intent mIntent = new Intent(AddAdsActivity.this, HomeActivity.class);
                                    startActivity(mIntent);
                                    finish();
                                } else {
                                    mLoginProgress.hide();
                                    String e = task.getException().getMessage();
                                    Toast.makeText(AddAdsActivity.this, "Database Error" + e, Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
