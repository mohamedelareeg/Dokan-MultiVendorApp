...
public class ProductsSnapAdapter extends RecyclerView.Adapter<ProductsSnapAdapter.ViewHolder>  implements Filterable {
    ...
    public ProductsSnapAdapter(List<Products> _productList , OnProductClickListener onProductClickListener )
    {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        if(products.getShortname() != null) {
            String name = products.getShortname();
