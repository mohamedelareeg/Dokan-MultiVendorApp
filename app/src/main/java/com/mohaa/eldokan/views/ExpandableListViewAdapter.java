...
public class ExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public ExpandableListViewAdapter(Context context, List<String> listDataGroup,
                                     HashMap<String, List<Products>> listChildData) {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        price.setText(String.valueOf(childText.getPrice()));
        ...
        //Toast.makeText(context, "" + childText.getType(), Toast.LENGTH_SHORT).show();
        return convertView;
    }
